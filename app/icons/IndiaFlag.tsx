export default function IndianFlag() {
    return <svg xmlns="http://www.w3.org/2000/svg"  width="5vw" height="5vw" viewBox="0 0 64 64" aria-hidden="true" role="img" className="iconify iconify--emojione h-10 w-10 rounded-full" preserveAspectRatio="xMidYMid meet">
